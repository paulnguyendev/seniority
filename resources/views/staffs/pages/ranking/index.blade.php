...
@section('title', 'List of Rankings')
@section('page_title', 'List of Rankings')
...
@section('content')
    ...
    @include('share.page_title', [
        ...
        'showCheckboxRanking' => '1',
        'showCheckboxUrl' => route("{$routeName}/setting"),
    ])
    <div class="row">
        <div class="col-md-12">
            @if (Setting::getValue('show_ranking_mortgage_ambassador') == '1')
                <div class="card">
                    <div class="d-flex align-items-center justify-content-between card-header-obn">
                        <h4 class="card-title font-20 obn-card-title mt-0">List Ranking of Mortgage Ambassador
                        </h4>
                        ...
                        <table class="table table-xlg non-license-data obn-table" id="licences">
                            <thead>
                                <tr>
                                    ...
                                    <th>Ranking Name </th>
                                    <th class="text-center">Personal Payout </th>
                                    <th class="text-center">Team Overrides</th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
            ...
            @endif
            @if (Setting::getValue('show_ranking_community_ambassador') == '1')
                <div class="card">
                    <div class="d-flex align-items-center justify-content-between card-header-obn">
                        <h4 class="card-title font-20 obn-card-title mt-0">List Ranking of Community Ambassador
                        </h4>
