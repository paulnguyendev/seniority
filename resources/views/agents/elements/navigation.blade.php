...
<header id="topnav">
    <div class="topbar-main">
        <div class="container-fluid">
            <!-- Logo container-->
            <div class="logo">
                <a href="{{ route('agents/license/dashboard/index') }}" class="logo">
                ...
                <ul class="list-unstyled float-right mb-0">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle arrow-none waves-effect nav-user" data-toggle="dropdown"
                            ...
                            <img src="{{Agent::getLicenseAgentInfo('','thumbnail')}}"
                                alt="user" class="rounded-circle">
                            <span class="nav-user-title">{{ Agent::getLicenseAgentInfo('', 'fullname') }} </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown  border-0">
                            ...
                            <a class="dropdown-item" href="{{ route('agents/license/auth/logout') }}"><i
            ...
            <div id="navigation">
                ...
                <ul class="navigation-menu">
                    <li class="has-submenu">
                        <a href="{{ route('agents/license/dashboard/index') }}"><i class="dripicons-device-desktop"></i>Dashboard</a>
                    </li>
                    {{-- <li>
