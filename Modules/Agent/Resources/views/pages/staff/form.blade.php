                    ...
                    <form
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    @php
                                        $types = config('obn.agent_type');
                                        $type = $item['type'] ?? '';
                                    @endphp
                                    <label for="text">Agent Type (*)</label>
                                    <select name="type" id="" class="form-control">
                                        <option value="">Choose Agent Type</option>
                                        @foreach ($types as $keyType => $itemType)
                                            <option value="{{$keyType}}" {{ $type == $keyType ? 'selected' : '' }}>{{$itemType['name'] ?? ""}}
                                            </option>
                                        @endforeach
                                    ...
                                    <select name="parent_id" id="" class="form-control select2">
                                        ...
                                        @foreach ($agents as $agent)
                                            <option value="{{ $agent['id'] }}" {{$parent_id == $agent['id'] ? "selected" : ""}}>
                                                {{ UserHelper::getAgentInfo($agent['id'], 'fullname') }}</option>
                                        @endforeach
                                    </select>
                                    <span class="help-block"></span>
                                </div>
