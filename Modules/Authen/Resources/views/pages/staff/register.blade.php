...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <div class="p-3">
                <form class="form-horizontal m-t-20" id="form-submit" action="{{ route('auth_agent/postRegister') }}"
                    method="post">
                    ...
                    <div class="form-group m-t-10 mb-0 text-center">
                        Already have account? <a class="text-info" href="{{route('auth_agent/login')}}"> Sign In</a>
                    </div>
                </form>
            </div>
        </div>
