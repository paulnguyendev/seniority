...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <h1 class="text-center title-auth">Agent Sign Up</h1>
            <div class="p-3">
                <form class="form-horizontal m-t-20" id="form-submit" action="{{ route('auth_api/agentSignup') }}"
                    method="post">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Sponsor ID" id="sponsor_id"
                                    id="sponsor_id" data-url="{{ route('auth_agent/agentCheckParent') }}" name="sponsor_id">
                                <span class="help-block"></span>
                    ...
                    <div class="form-group m-t-10 mb-0 row">
                        <div class="col-sm-7 m-t-20">
                            <a href="{{ route("{$controllerName}/forget") }}" class="text-muted"><i
                                    class="mdi mdi-lock"></i> <small>Forgot
                                    your password ?</small></a>
                        </div>
                        <div class="col-sm-5 m-t-20">
                            <a href="{{ route("{$controllerName}/register") }}" class="text-muted"><i
