...
WBDatatablesClass.prototype = {
    ...
    showThumbnail: function (thumbnail) {
        ...
        return '<img class="thumb-sm  rounded-circle " src="' + thumbnail + '">';
    },
    ...
    showRemoveIcon: function (remove_link, title=null, message=null) {
        return '<a href="' + remove_link + '" class="remove_item text-danger-600" data-title="'+title+'" data-message="'+message+'" title = "Trash"><i class="icon-trash"></i></a>';
    },
