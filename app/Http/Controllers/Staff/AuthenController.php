...
use App\Models\StaffModel as MainModel;
class AuthenController extends Controller
{
    private $pathViewController     = "staffs.pages.auth";
    private $controllerName         = "auth";
    private $routeName         = "staffs/auth";
    private $model;
    private $params                 = [];
    ...
    public function postLogin(Request $request)
    {
        ...
        $params['redirect'] = route('staffs/dashboard/index');
    ...
    {
        $request->session()->forget('staffInfo');
